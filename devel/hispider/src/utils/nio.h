...
#define NIO_INIT(ptr) {ptr = ((NIO *)calloc(1, sizeof(NIO)));MUTEX_INIT(PF(ptr)->mutex);}
...
#define NIO_FLOCK(ptr) ((PF(ptr)) ? flock(PFD(ptr), LOCK_EX) : -1)
#define NIO_FUNLOCK(ptr) ((PF(ptr)) ? flock(PFD(ptr), LOCK_UN) : -1)
#define NIO_LOCK(ptr) ((PF(ptr) && PF(ptr)->mutex) ? (MUTEX_LOCK(PF(ptr)->mutex)) : -1)
#define NIO_UNLOCK(ptr) ((PF(ptr)) ? (MUTEX_UNLOCK(PF(ptr)->mutex)) : -1)
...
#define NIO_CLEAN(ptr) {if(ptr){close(PFD(ptr));MUTEX_DESTROY(PF(ptr)->mutex);free(ptr);ptr = NULL;}}
#endif
